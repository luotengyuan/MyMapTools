...
namespace GMapUtil
{
    public static class PolygonUtils
    {
        ...
        public static RectLatLng GetRegionMaxRect(List<PoiData> poiList)
        {
            double latMin = 90;
            double latMax = -90;
            double lngMin = 180;
            double lngMax = -180;
            foreach (var point in poiList)
            {
                if (point.Lat < latMin)
                {
                    latMin = point.Lat;
        ...
        public static RectLatLng GetRegionMaxRect(List<PointLatLng> pointList)
        {
            double latMin = 90;
            double latMax = -90;
            double lngMin = 180;
