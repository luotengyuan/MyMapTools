    ...
    public partial class MainForm : Form
    {
        ...
        void mapControl_OnPolygonDoubleClick(GMapPolygon item, MouseEventArgs e)
        {
            if (item is GMapAreaPolygon)
            {
                ...
                {
                    CommonTools.MyMessageBox.ShowTipMessage("请先用画图工具画下载的区域多边形或选择省市区域！");
                }
            }
        }
        ...
        private void DownloadMap(GMapPolygon polygon)
        {
            if (polygon != null)
            {
                ...
                {
                    CommonTools.MyMessageBox.ShowWarningMessage("正在下载地图，等待下载完成！");
                }
                else
                {
        ...
        void buttonMapImage_Click(object sender, EventArgs e)
        {
            ...
            {
                CommonTools.MyMessageBox.ShowTipMessage("请先用“矩形”画图工具选择区域");
            }
        }
            ...
            using (FileDialog dialog = new OpenFileDialog())
            {
                ...
                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        CommonTools.MyMessageBox.ShowTipMessage("读取GPX文件错误");
                    }
                }
            }
        }
        ...
        private void 读取KMLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception exception)
            {
                ...
                CommonTools.MyMessageBox.ShowTipMessage("读取KML文件时出现异常");
            }
        }
        ...
        private void buttonPOISearch_Click(object sender, EventArgs e)
        {
            ...
            if (province == null)
            {
                CommonTools.MyMessageBox.ShowTipMessage("请选择POI查询的省份！");
                return;
            }
            ...
            if (city == null)
            {
                CommonTools.MyMessageBox.ShowTipMessage("请选择POI查询的城市！");
                return;
            }
            ...
            {
                CommonTools.MyMessageBox.ShowTipMessage("请输入POI查询的关键字！");
                return;
            }
        ...
        private void 以此为终点ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MapRoute route = GMapProvidersExt.AMap.AMapProvider.Instance.GetTransitRoute(routeStartPoint, routeEndPoint, currentCenterCityName);
        ...
        private void buttonPoiSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    CommonTools.MyMessageBox.ShowTipMessage("POI数据为空，无法保存！");
                    return;
                }
